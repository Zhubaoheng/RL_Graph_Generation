...
class SpectreSamplingMetrics(nn.Module):
    ...
    def forward(
        ...
        if "degree" in self.metrics_list:
            ...
            try:
                if swanlab.run:
                    swanlab.log({"summary/degree": degree})
            except:
                pass
        ...
        if "wavelet" in self.metrics_list:
            ...
            try:
                if swanlab.run:
                    swanlab.log({"summary/wavelet": wavelet})
            except:
                pass
        ...
        if "spectre" in self.metrics_list:
            ...
            try:
                if swanlab.run:
                    swanlab.log({"summary/spectre": spectre})
            except:
                pass
        ...
        if "clustering" in self.metrics_list:
            ...
            try:
                if swanlab.run:
                    swanlab.log({"summary/clustering": clustering})
            except:
                pass
        ...
        if "motif" in self.metrics_list:
            ...
            try:
                if swanlab.run:
                    swanlab.log({"summary/motif": motif})
            except:
                pass
        ...
        if "orbit" in self.metrics_list:
            ...
            try:
                if swanlab.run:
                    swanlab.log({"summary/orbit": orbit})
            except:
                pass
        ...
        if "sbm" in self.metrics_list:
            ...
            try:
                if swanlab.run:
                    swanlab.log({"summary/sbm_acc": sbm_acc})
            except:
                pass
        ...
        if "planar" in self.metrics_list:
            ...
            try:
                if swanlab.run:
                    swanlab.log({"summary/planar_acc": planar_acc})
            except:
                pass
        ...
        if "tree" in self.metrics_list:
            ...
            try:
                if swanlab.run:
                    swanlab.log({"summary/tree_acc": tree_acc})
            except:
                pass
